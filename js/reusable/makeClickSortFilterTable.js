...
//function makeClickSortFilterTable(title, objList, sortOrderPropName, sortIcon) {

function makeClickSortFilterTable(tableList){
    ...
    var title = tableList.title;
    var objList = tableList.objList;
    var sortIcon = tableList.sortIcon;
    var sortOrderPropName = tableList.sortOrderPropName;
